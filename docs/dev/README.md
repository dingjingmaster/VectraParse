...
| 4 | 2026-06-01 | L3 | plan | [4-plan-ocr-preprocessing-optimization.md](4-plan-ocr-preprocessing-optimization.md) | 已完成 | 已完成 OCR 图片入口识别、预处理增强、失败诊断、OLE 嵌入图处理、布局/颜色/纹理区域补充、行级修复、宽行分段、高分辨率 tile 补充、二维区域候选和 golden/验证收口。 |
