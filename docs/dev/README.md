...
|----|------|------|------|------|------|------|
| 1 | 2026-05-27 | L4 | research | [1-research-rust-tika-rewrite.md](1-research-rust-tika-rewrite.md) | 已完成 | 调研 `/data/source/tika` 项目结构，明确 Rust 静态库/动态库重写的范围、架构边界、风险和分阶段建议。 |
