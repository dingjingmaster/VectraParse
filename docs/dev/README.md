...
| 4 | 2026-06-01 | L3 | plan | [4-plan-ocr-preprocessing-optimization.md](4-plan-ocr-preprocessing-optimization.md) | 已完成 | 已完成 OCR 图片入口识别、预处理增强、失败诊断、OLE 嵌入图处理和 golden/验证收口，优先解决部分图片无法提取文字的问题。 |
